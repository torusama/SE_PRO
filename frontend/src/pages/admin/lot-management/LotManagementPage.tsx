...
const INITIAL_NOTIFS: SystemNotif[] = [
  {
    ...
    title: "Hợp đồng HD-2022-0031 sắp hết hạn",
    desc: "Hợp đồng dịch vụ của Phạm Văn Tuấn (lô C-18) hết hạn 31/07/2025. Cần liên hệ gia hạn.",
    time: "09:00",
    unread: true,
    action: "Liên hệ KH",
  },
  {
    ...
    title: "Thanh toán thành công — 28.500.000 đ",
    desc: "Nguyễn Bích Chi (KH-0127) đã thanh toán hợp đồng HD-2025-0071. Biên lai đã gửi email.",
    time: "Hôm qua",
  },
  {
    id: "n4",
    ...
    title: "Broadcast đã gửi — 247 khách hàng",
    desc: "Thông báo lịch bảo trì khu A đã gửi thành công. Tỷ lệ đọc: 84%.",
    time: "25/06",
    broadcast: true,
  },
];
    ...
    <div style={{ display: "grid", gap: 18 }}>
      ...
      >
        <div>
          ...
          >
            Broadcast &amp; quản lý thông báo tới khách hàng
          </p>
        </div>
      </header>
      ...
      >
              ...
              {TABS.map((t) => (
                <button
                  ...
                  style={{
                    border: "1px solid var(--color-border)",
                    background:
                      tab === t ? "rgba(0,200,160,0.14)" : "transparent",
                    color:
                      tab === t
        ...
        <div style={{ ...panelStyle, padding: 20, alignSelf: "start" }}>
          ...
          <div style={{ display: "grid", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setChannels((c) => ({ ...c, inApp: e.target.checked }))
                    }
                  />{" "}
                  In-app
                </label>
            ...
            {sentMessage ? (
              <div style={{ fontSize: 12, color: "var(--color-accent-teal)" }}>
                {sentMessage}
              </div>
            ) : null}
