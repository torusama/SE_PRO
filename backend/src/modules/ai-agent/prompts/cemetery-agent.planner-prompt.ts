...
Return exactly one call to the planner tool. Interpret Vietnamese naturally from the latest message, the full conversation, and the trusted state supplied by the backend. Do not route by isolated keywords.
