    ...
    good: [
      {
        direction: 'Đông Nam',
        star: 'Sinh Khí',
        meaning: 'Phúc đức vượng tiến, tài lộc dồi dào',
      },
      {
        direction: 'Đông',
        star: 'Thiên Y',
        meaning: 'Thần khí bảo hộ, gia đạo an yên',
      },
      {
        direction: 'Nam',
        star: 'Diên Niên',
        meaning: 'Bền vững trường tồn, con cháu hòa thuận',
      },
      {
        direction: 'Bắc',
        star: 'Phục Vị',
        meaning: 'Củng cố tinh thần, tĩnh tâm phát triển',
      },
    ],
    bad: [
      {
        direction: 'Tây Nam',
        star: 'Tuyệt Mệnh',
        meaning: 'Triệt tiêu sinh khí, tổn hại gia đạo',
      },
      {
        direction: 'Đông Bắc',
        star: 'Ngũ Quỷ',
        meaning: 'Gây xáo trộn năng lượng, mâu thuẫn',
      },
      {
        direction: 'Tây Bắc',
        star: 'Lục Sát',
        meaning: 'Trì trệ, trắc trở tài lộc',
      },
      {
        direction: 'Tây',
        star: 'Họa Hại',
        meaning: 'Tổn hao sinh lực, trắc trở nhỏ',
      },
    ],
  },
  2: {
    ...
    good: [
      ...
      },
      {
        direction: 'Tây',
        star: 'Thiên Y',
        meaning: 'Thần khí bảo hộ, sức khỏe trường thọ',
      },
      {
        direction: 'Tây Bắc',
        star: 'Diên Niên',
        meaning: 'Hòa thuận trường tồn, an gia lập nghiệp',
      },
      {
        direction: 'Tây Nam',
        star: 'Phục Vị',
        meaning: 'Vững vàng nền tảng, gia đạo vững chắc',
      },
    ],
    bad: [
      {
      ...
      },
      {
        direction: 'Đông Nam',
        star: 'Ngũ Quỷ',
        meaning: 'Gây xáo trộn năng lượng',
      },
      { direction: 'Nam', star: 'Lục Sát', meaning: 'Trì trệ, xung khắc' },
      {
        direction: 'Đông',
        star: 'Họa Hại',
        meaning: 'Tổn hao năng lượng, thị phi',
      },
    ],
  },
  3: {
    ...
    good: [
      {
        direction: 'Nam',
        star: 'Sinh Khí',
        meaning: 'Vượng khí hưng thịnh, phát đạt',
      },
      {
        direction: 'Bắc',
        star: 'Thiên Y',
        meaning: 'Giải trừ bệnh tật, an lành khang thái',
      },
      {
        direction: 'Đông Nam',
        star: 'Diên Niên',
        meaning: 'Gia đình gắn kết, trường thọ',
      },
      {
        direction: 'Đông',
        star: 'Phục Vị',
        meaning: 'Vững nền gia phong, bình yên',
      },
    ],
    bad: [
      {
        direction: 'Tây',
        star: 'Tuyệt Mệnh',
        meaning: 'Triệt tiêu sinh khí, tổn hại tài vận',
      },
      {
        direction: 'Tây Bắc',
        star: 'Ngũ Quỷ',
        meaning: 'Xáo trộn khí vận, thị phi',
      },
      {
        direction: 'Đông Bắc',
        star: 'Lục Sát',
        meaning: 'Hao tổn tài lộc, trắc trở',
      },
      {
        direction: 'Tây Nam',
        star: 'Họa Hại',
        meaning: 'Bất hòa, suy giảm sinh lực',
      },
    ],
  },
  4: {
    ...
    good: [
      {
        direction: 'Bắc',
        star: 'Sinh Khí',
        meaning: 'Vượng tài sinh lộc, con cháu phát hiền',
      },
      {
        direction: 'Nam',
        star: 'Thiên Y',
        meaning: 'Bảo hộ bình an, quý nhân phù trợ',
      },
      {
        direction: 'Đông',
        star: 'Diên Niên',
        meaning: 'Trường thọ, gắn kết huyết thống',
      },
      {
        direction: 'Đông Nam',
        star: 'Phục Vị',
        meaning: 'Ổn định tâm trí, an yên tự tại',
      },
    ],
    bad: [
      {
        direction: 'Đông Bắc',
        star: 'Tuyệt Mệnh',
        meaning: 'Tổn hao vượng khí, nguy hại',
      },
      {
        direction: 'Tây Nam',
        star: 'Ngũ Quỷ',
        meaning: 'Gây bất hòa gia đạo, tai tiếng',
      },
      {
        direction: 'Tây',
        star: 'Lục Sát',
        meaning: 'Trắc trở sự nghiệp, hao sinh lực',
      },
    ...
    good: [
      {
        direction: 'Tây',
        star: 'Sinh Khí',
        meaning: 'Tài lộc hưng vượng, sự nghiệp đỉnh cao',
      },
      {
        direction: 'Đông Bắc',
        star: 'Thiên Y',
        meaning: 'Trường thọ khang an, thần minh độ trì',
      },
      {
        direction: 'Tây Nam',
        star: 'Diên Niên',
        meaning: 'Hữu hảo hòa thuận, phúc đức vĩnh cửu',
      },
      {
        direction: 'Tây Bắc',
        star: 'Phục Vị',
        meaning: 'Tĩnh tại tâm an, củng cố uy quyền',
      },
    ],
    bad: [
      {
        direction: 'Nam',
        star: 'Tuyệt Mệnh',
        meaning: 'Triệt tiêu dương khí, tổn hại tài lộc',
      },
      {
        direction: 'Đông',
        star: 'Ngũ Quỷ',
        meaning: 'Xung khắc tài vận, rắc rối',
      },
      {
        direction: 'Bắc',
        star: 'Lục Sát',
        meaning: 'Trì trệ phúc khí, thị phi',
      },
      {
        direction: 'Đông Nam',
        star: 'Họa Hại',
        meaning: 'Tổn thất sinh lực, phiền muộn',
      },
    ],
  },
  7: {
    ...
    good: [
      {
        direction: 'Tây Bắc',
        star: 'Sinh Khí',
        meaning: 'Phúc lộc vẹn toàn, thăng tiến vượng tài',
      },
      {
        direction: 'Tây Nam',
        star: 'Thiên Y',
        meaning: 'Bình an sức khỏe, hanh thông mọi sự',
      },
      {
        direction: 'Đông Bắc',
        star: 'Diên Niên',
        meaning: 'Bền vững tình thân, trường thọ',
      },
      {
        direction: 'Tây',
        star: 'Phục Vị',
        meaning: 'Bình yên nội tại, giữ vững thành quả',
      },
    ],
    bad: [
      {
        direction: 'Đông Nam',
        star: 'Tuyệt Mệnh',
        meaning: 'Tổn hao vượng khí, xấu nhất',
      },
      {
        direction: 'Nam',
        star: 'Ngũ Quỷ',
      ...
      },
      {
        direction: 'Đông',
        star: 'Lục Sát',
        meaning: 'Trắc trở công danh, hao tốn',
      },
      {
        direction: 'Bắc',
        star: 'Họa Hại',
        meaning: 'Suy giảm năng lượng, rắc rối nhỏ',
      },
    ],
  },
  8: {
    ...
    good: [
      {
        direction: 'Tây Nam',
        star: 'Sinh Khí',
        meaning: 'Vượng khí sinh tài, con cháu hiển đạt',
      },
      {
        direction: 'Tây Bắc',
        star: 'Thiên Y',
        meaning: 'Trường thọ an lành, bảo hộ gia quyến',
      },
      {
        direction: 'Tây',
        star: 'Diên Niên',
        meaning: 'Trường tồn vĩnh cữu, gắn kết gia đạo',
      },
      {
        direction: 'Đông Bắc',
        star: 'Phục Vị',
        meaning: 'An định vững chãi, tâm tĩnh tự tại',
      },
    ],
    bad: [
      {
        direction: 'Bắc',
        star: 'Tuyệt Mệnh',
        meaning: 'Tổn hại sinh khí, triệt tiêu phúc đức',
      },
      {
        direction: 'Đông',
        star: 'Lục Sát',
        meaning: 'Bất hòa, suy giảm hanh thông',
      },
      {
        direction: 'Đông Nam',
        star: 'Họa Hại',
        meaning: 'Trắc trở công việc, hao tổn',
      },
      {
        direction: 'Nam',
        star: 'Ngũ Quỷ',
        meaning: 'Xáo trộn phong thủy, phiền muộn',
      },
    ],
  },
  9: {
    ...
    good: [
      {
        direction: 'Đông',
        star: 'Sinh Khí',
        meaning: 'Phúc lộc dồi dào, sinh khí dâng cao',
      },
      {
        direction: 'Đông Nam',
        star: 'Thiên Y',
        meaning: 'Khang thái trường thọ, gặp may mắn',
      },
      {
        direction: 'Bắc',
        star: 'Diên Niên',
        meaning: 'Gia đạo êm ấm, trường tồn vinh hoa',
      },
      {
        direction: 'Nam',
        star: 'Phục Vị',
        meaning: 'Giữ vững vị thế, bình an tĩnh lặng',
      },
    ],
    bad: [
      {
        direction: 'Tây Bắc',
        star: 'Tuyệt Mệnh',
        meaning: 'Triệt tiêu khí vận, nguy hại',
      },
      { direction: 'Tây', star: 'Ngũ Quỷ', meaning: 'Gây thị phi bất hòa' },
      {
        direction: 'Tây Nam',
        star: 'Lục Sát',
        meaning: 'Hao tài tốn lực, rắc rối',
      },
      {
        direction: 'Đông Bắc',
        star: 'Họa Hại',
        meaning: 'Trắc trở nhỏ, suy giảm năng lượng',
      },
    ],
  },
};
...
export class BaziRuleService {
  suggest(input: {
    ...
    const alternativeDirections = batTrach.good
      .slice(1)
      .map((g) => g.direction);
    const elementRel =
      ELEMENT_RELATIONS[napAm.element] || ELEMENT_RELATIONS.Thổ;
